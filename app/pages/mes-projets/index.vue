<template>
  <section class="bg-black">
    <div class="flex flex-col justify-center items-center px-6 py-12 md:p-10 gap-y-5 bg-gradient-to-br from-lavand/20 via-black to-turq/20 text-center">
    ...
    <!-- GRID CARTES -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 bg-gradient-to-bl from-turq/20 via-black to-lavand/15 px-5 py-10 md:px-10 lg:px-16 xl:px-20">
      <NuxtLink
