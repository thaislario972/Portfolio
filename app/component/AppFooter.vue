...
<template>
<div class="w-full h-40 bg-stone-950 flex lg:flex-row md:flex-row sm:flex-col sm:gap-5 items-center p-10 justify-around">
  <p class="text-white/80 text-lg">&copy; 2026 Thaïs Lario. Tous droits réservés</p>
  <div class="flex items-center sm:gap-10 gap-5 ">
